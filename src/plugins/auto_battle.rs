...
fn handle_cyclops_attack(
    ...
    if let Some(AttackEvent(_, cyclops_entity, enemy_entity)) =
        attack_events.iter().find(|ev| ev.0 == AllyType::Cyclops)
    {
...
fn handle_archer_attack(
    ...
    if let Some(AttackEvent(_, archer_entity, enemy_entity)) =
        attack_events.iter().find(|ev| ev.0 == AllyType::Archer)
    {
...
fn handle_dwarf_attack(
    ...
    if let Some(AttackEvent(_, dwarf_entity, enemy_entity)) =
        attack_events.iter().find(|ev| ev.0 == AllyType::Dwarf)
    {
...
fn handle_knight_attack(
    ...
    if let Some(AttackEvent(_, knight_entity, enemy_entity)) =
        attack_events.iter().find(|ev| ev.0 == AllyType::Knight)
    {
...
fn handle_player_attack(
    ...
    if let Some(AttackEvent(_, player_entity, enemy_entity)) =
        attack_events.iter().find(|ev| ev.0 == AllyType::Player)
    {
...
fn handle_wizard_attack(
    ...
    if let Some(AttackEvent(_, wizard_entity, enemy_entity)) =
        attack_events.iter().find(|ev| ev.0 == AllyType::Wizard)
    {
...
fn handle_bat_attack(
    ...
    if let Some(AttackEvent(_, bat_entity, ally_entity)) =
        attack_events.iter().find(|ev| ev.0 == EnemyType::Bat)
    {
...
fn handle_evil_wizard_attack(
    ...
    if let Some(AttackEvent(_, evil_wizard_entity, ally_entity)) = attack_events
        .iter()
        .find(|ev| ev.0 == EnemyType::EvilWizard)
    {
...
fn handle_ghost_attack(
    ...
    if let Some(AttackEvent(_, ghost_entity, ally_entity)) =
        attack_events.iter().find(|ev| ev.0 == EnemyType::Ghost)
    {
...
fn handle_lobster_attack(
    ...
    if let Some(AttackEvent(_, lobster_entity, ally_entity)) =
        attack_events.iter().find(|ev| ev.0 == EnemyType::Lobster)
    {
...
fn handle_rat_attack(
    ...
    if let Some(AttackEvent(_, rat_entity, ally_entity)) =
        attack_events.iter().find(|ev| ev.0 == EnemyType::Rat)
    {
...
fn handle_spider_attack(
    ...
    if let Some(AttackEvent(_, spider_entity, ally_entity)) =
        attack_events.iter().find(|ev| ev.0 == EnemyType::Spider)
    {
